 ...
 * My app title
 **/
public class TitleGoup extends LinearLayout {
    ...
    public TitleGoup(Context context) {
        super(context);

        init();
    }

    public TitleGoup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TitleGoup(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        viewAppTitle = inflater.inflate(R.layout.public_title, null);
